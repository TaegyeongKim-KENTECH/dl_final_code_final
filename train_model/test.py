...
model_save_path = '/home/work/ktg0829/final_project/Dual-Path-AI-Generated-Image-Detection/weights/model_save/model_epoch_1_20250417-211519.pth'
model = OpenClipLinear(normalize=True, next_to_last=True, pretrained_model_path='../weights/open_clip_pytorch_model.bin')
model.load_state_dict(torch.load(model_save_path, map_location=device))
model.to(device)
print(f"Using device: {device}")
# 准备数据集
test_dataset = TestDataset1(is_train=False, args={'data_path': '/home/work/ktg0829/final_project/Dual-Path-AI-Generated-Image-Detection/testset/', 'eval_data_path': '/home/work/ktg0829/final_project/Dual-Path-AI-Generated-Image-Detection/testset/'})
